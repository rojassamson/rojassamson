...
<div class="backgroundSobreVideo--footer"></div>
<div class="container">
  <div class="row">
      <p class="text-center col-12">© 2023 - Ignacio Rojas Samson - Todos los derechos reservados</p>
  </div>
  <div class="row">
      <div class="gridFooter">
        <div class="redesSociales">
          ...
          <div>
            <a href="#"><svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" class="bi bi-whatsapp" viewBox="0 0 16 16">
...
const navegacionIndex = document.querySelector("#headerIndex");
const footerIndex = document.querySelector("#footerIndex")
const navegacionPages = document.querySelector("#headerPages");
const footerPages = document.querySelector("#footerPages");
...
try {
  ...
  footerIndex.querySelector("video").setAttribute("src", "./assets/video/footerBackground.mp4");
  footerIndex.querySelector(".pagesFooter").querySelectorAll("a").forEach((link,index) => {
    if (index == 0) {
      link.setAttribute("href", "./index.html");
    } else if (index == 1) {
      link.setAttribute("href", "./pages/sobre_mi.html");
  ...
  footerPages.querySelector("video").setAttribute("src", "../assets/video/footerBackground.mp4");
  footerPages.querySelector(".pagesFooter").querySelectorAll("a").forEach((link,index) => {
    if (index == 0) {
      link.setAttribute("href", "../index.html");
    } else if (index == 1) {
      link.setAttribute("href", "./sobre_mi.html");
